...
public class Hotel{
	...
	public Hotel(Long id, String name, String address, Integer rating, Long operatesFrom, PaymentMethod paymentMethod, Category category, String url, String description) {
		super();
		this.id = id;
		this.name = name;
		this.address = address;
